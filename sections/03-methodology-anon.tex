% Section 3: Methodology (Anonymized for review)
...
We employ autoethnography---systematic self-study where the researcher is both subject and analyst---enhanced with computational data collection. This approach follows methodological traditions in developer cognition research \cite{silva2025dmmf}, extending reflexive analysis from historical artifacts to real-time interaction.

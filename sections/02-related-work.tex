...
Our prior work, the Developer Mental Model Framework (DMMF) \cite{silva2025dmmf}, demonstrated that cognitive patterns could be inferred from software artifacts. Analyzing 40 repositories and 2,799 commits, DMMF identified four dimensions of developer cognition: cognitive, affective, conative, and reflective.

The present study extends DMMF from artifact analysis to interaction analysis, capturing not what developers produce but how they produce it through human-AI collaboration.
